...
document.addEventListener('click', (e) => {
    ...
    document.querySelector('.popular__btn.btn--active')?.classList.remove('btn--active')
...
const swiper = new Swiper(".say__slider-content", {
...
cards.forEach(card => obser.observe(card));